...
%>
    ...
    <p>Ya puedes <a href="../index.jsp">Iniciar Sesión</a></p><%
...
%>
    ...
    <p>Una Disculpa Vuelve a <a href="../signinDocente.html">Crear Usuario</a></p>
    <p><a href="../index.jsp">Iniciar Sesión</a></p><%
            }
        }catch(Exception e){
