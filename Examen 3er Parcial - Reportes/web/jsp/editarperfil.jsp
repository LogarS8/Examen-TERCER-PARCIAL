        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <span class="h2 fw-bold mb-0">REPORTES</span>
                </div><%
    ...
    %>
                <div class="text-center">
                    <form style="width: 23rem;" method="post" name="profesores" action="perfil.jsp">
                        <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Seccion editar perfil</h3>
            ...
            %>
                            ...
                            <div class="pt-1 mb-4">
                                <label class="form-label"><input class="btn btn-outline-success btn-lg px-5" type="submit" value="Editar Perfil"></label>
                            </div>
                        </div>
                    </form>
                    <form action="inicioS.jsp" method="post" name="return">
                        ...
                        <div>
                            <label class="form-label"><input class="btn btn-outline-success btn-lg px-5" type="submit" value="Regresar a Inicio"></label>
                        </div>
            </div>
        </div>
    </section>
