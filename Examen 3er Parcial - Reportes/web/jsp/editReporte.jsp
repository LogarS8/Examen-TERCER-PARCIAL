    ...
    <h1><i>REGISTRO DE REPORTES DE INMUEBLES CECYT 9</i></h1><%
        ...
        try{
            ...
            try{
                ...
                int pro_numempleado, lab_id, asi_id, pri_id, rep_id;
                ...
                rep_id = Integer.parseInt(request.getParameter("rep_id"));
                
                String qz = "update reportes SET lab_id="+lab_id+", equ_etiqueta='"+equ_etiqueta+"', asi_id="+asi_id+", rep_problema='"+rep_problema+"', rep_estado='"+rep_estado+"', pri_id="+pri_id+" where rep_id="+rep_id+";";
